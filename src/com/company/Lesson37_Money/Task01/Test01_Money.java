...
*/
public class Test01_Money {
    public static void main(String[] args) {
        Person person = new Person("Иван", 40.0, 50.0);
        for (Money money : Person.allMoney) {
