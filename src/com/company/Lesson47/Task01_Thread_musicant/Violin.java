...
public class Violin implements MusicalInstrument {
    ...
    Violin(String musical) {
        this.musical = musical;
    }

    @Override
    public Date startPlaying() {
        System.out.println("Музыкант " + musical + " начал играть");
        return new Date();
    }

    @Override
    public Date stopPlaying() {
        System.out.println("Музыкант " + musical + " закончил играть");
        return new Date();
    }
    ...
    public void run() {
        ...
        Test01_Thread_musicant.sleepNSeconds(1);
        Date date2 = stopPlaying();
        System.out.println("Playing " + (date2.getTime() - date1.getTime()));
    }
}
